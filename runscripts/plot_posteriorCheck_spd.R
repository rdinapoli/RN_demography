...
# Model 1
pdf(file = here('figures','supplemental','posterior_predictive_check_model1_spd_euc.pdf'),width = 7,height = 8)
...
pdf(file = here('figures','supplemental','posterior_predictive_check_model1_spd_nrmse.pdf'),width = 7,height = 8)
par(mfrow=c(2,2),mar=c(5,4,2,1))
...
# Model 2
pdf(file = here('figures','supplemental','posterior_predictive_check_model2_spd_euc.pdf'),width = 7,height = 8)
par(mfrow=c(2,2),mar=c(5,4,2,1))
...
pdf(file = here('figures','supplemental','posterior_predictive_check_model2_spd_nrmse.pdf'),width = 7,height = 8)
par(mfrow=c(2,2),mar=c(5,4,2,1))
...
# Model 3
pdf(file = here('figures','supplemental','posterior_predictive_check_model3_spd_euc.pdf'),width = 7,height = 8)
par(mfrow=c(2,2),mar=c(5,4,2,1))
...
pdf(file = here('figures','supplemental','posterior_predictive_check_model3_spd_nrmse.pdf'),width = 7,height = 8)
par(mfrow=c(2,2),mar=c(5,4,2,1))
...
# Model 4
pdf(file = here('figures','supplemental','posterior_predictive_check_model4_spd_euc.pdf'),width = 7,height = 8)
par(mfrow=c(2,2),mar=c(5,4,2,1))
...
pdf(file = here('figures','supplemental','posterior_predictive_check_model4_spd_nrmse.pdf'),width = 7,height = 8)
par(mfrow=c(2,2),mar=c(5,4,2,1))
