## A robust approach for modeling human demography and paleodemographic interactions using Approximate Bayesian Computation: an example from Rapa Nui (Easter Island): source code, data, scripts, and Shiny app
